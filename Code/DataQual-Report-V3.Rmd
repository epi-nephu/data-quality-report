...
```{r define files}
#condition_mu_file <- "NEPHUCaseLinelistDQReport_MU.xlsx"

condition_others_file <- "NEPHUCaseLinelistDQReport_Others.xlsx"

#condition_all_file <- "NEPHUCaseLinelistDQReport_All.xlsx"

condition_exceptions_file <- "NEPHUCaseLinelistDQReport_Exceptions.xlsx"
...
```{r load data}
# mu.raw <- readxl::read_xlsx(file.path(phess_data_dir, condition_mu_file), sheet=1, guess_max=min(500000, Inf)) %>% janitor::clean_names() 

others.raw <- readxl::read_xlsx(file.path(phess_data_dir, condition_others_file), sheet=1, guess_max=min(500000, Inf)) %>% janitor::clean_names() 
...
condition.raw <- bind_rows(others.raw, exceptions.raw)
